...
//____________________________________________________________________________
bool SUSY3L_sync2::looseLepton(const Candidate* c, int idx, int pdgId) {
    /*
...
//____________________________________________________________________________
bool SUSY3L_sync2::fakableLepton(const Candidate* c, int idx, int pdgId, bool bypass){
    /*
...
//____________________________________________________________________________
bool SUSY3L_sync2::tightLepton(const Candidate* c, int idx, int pdgId){
    /*
...
//____________________________________________________________________________
void SUSY3L_sync2::setSelLine(string str) {
    /*
...
//____________________________________________________________________________
float SUSY3L_sync2::getFR(Candidate* cand, int idx) {
    /*
...
//____________________________________________________________________________
bool SUSY3L_sync2::multiLepSelection(){
    /*
...
//____________________________________________________________________________
void SUSY3L_sync2::advancedSelection(int WF){
    /*
    */
...
//____________________________________________________________________________
float SUSY3L_sync2::getTF_SingleFake(int ic){
    /*
...
//____________________________________________________________________________
float SUSY3L_sync2::getTF_DoubleFake(int ic){
    /*
...
//____________________________________________________________________________
float SUSY3L_sync2::getTF_TripleFake(int ic) {
    /*
        Function to extract transfer factor for TFF combination, 
        i.e. for double fake combinations
        parameters: number of fake-tight combination
...
//____________________________________________________________________________
bool SUSY3L_sync2::wzCRSelection(){
    /*
...
//____________________________________________________________________________
bool SUSY3L_sync2::ZMuMuSelection(){
    /*
...
//____________________________________________________________________________
bool SUSY3L_sync2::ZElElSelection(){
    /*
...
//____________________________________________________________________________
bool SUSY3L_sync2::ttbarSelection(){
    /*
...
//____________________________________________________________________________
vector<CandList> SUSY3L_sync2::build3LCombFake(const CandList tightLeps, vector<unsigned int> idxsT,
...
//____________________________________________________________________________
bool SUSY3L_sync2::hardLeg(CandList leptons, int n_hardestLeg, float cut_hardestLeg, int n_hardLeg, float cut_hardLeg){
    /*
...
//____________________________________________________________________________
float SUSY3L_sync2::lowestOssfMll(CandList leps){
    /*
...
//____________________________________________________________________________
void SUSY3L_sync2::fillValidationHistos(string reg){
    /*
...
//____________________________________________________________________________
float SUSY3L_sync2::MT2(Candidate* lep1, Candidate* lep2, Candidate* met, double mass_invisible){
    /*
...
//____________________________________________________________________________
void SUSY3L_sync2::sortSelectedLeps(CandList leps, std::vector<unsigned int> lepsIdx){
    /*
...
//____________________________________________________________________________
void SUSY3L_sync2::registerTriggerVars(){
    /*
...
//____________________________________________________________________________
void SUSY3L_sync2::readCSCevents(){
    /*
...
//____________________________________________________________________________
void SUSY3L_sync2::readEESCevents(){
    /*
...
//____________________________________________________________________________
void SUSY3L_sync2::readFilteredEvents(map< std::pair<int,std::pair<int,unsigned long int> > , unsigned int >& evts, vector<string> files){
    /*
...
//____________________________________________________________________________
bool SUSY3L_sync2::passNoiseFilters(){
    /*
...
//____________________________________________________________________________
bool SUSY3L_sync2::passCSCfilter(){
    /*
...
//____________________________________________________________________________
bool SUSY3L_sync2::passEESCfilter(){
    /*
...
//____________________________________________________________________________
bool SUSY3L_sync2::checkMassBenchmark(){
...
//____________________________________________________________________________
void SUSY3L_sync2::loadScanHistogram(){

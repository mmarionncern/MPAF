...
private:
  ...
  void fillFRMaps(std::string, int, string, int, string, int = SusyModule::kTight);
  void fillLepPlots(std::string, int, string, int,  string, int = SusyModule::kTight);
  void fillLeptonPlots();
  void fillJetPlots();
  void fillQcdEventPlots();
  void fillQcdFakeRatioMaps();
  void fillQcdLepPlots(std::string, int, string, int, string, int = SusyModule::kTight);
  void fillQcdLeptonPlots();
  void fillUcsxEwkEventPlots();
  void fillUcsxEwkLepPlots(std::string);//, int, string, int, string, int = SusyModule::kTight);
...
private: 
  ...
  unsigned int _nDenElsIso;
  unsigned int _nDenLepsIso;
  unsigned int _nDenMus;
  unsigned int _nNumEls;
  unsigned int _nNumLeps;
  unsigned int _nNumElsIso;
  unsigned int _nNumLepsIso;
  ...
  CandList _denLeps;
  CandList _denElsIso;
  CandList _denLepsIso;
  CandList _denMus;
  CandList _numEls;
  CandList _numLeps;
  CandList _numElsIso;
  CandList _numLepsIso;
  CandList _numMus;
  CandList _vetEls;
  CandList _vetLeps;
  CandList _vetMus;
  ...
  vector<pair<unsigned int, string> > _denElsIsoIdx;
  vector<pair<unsigned int, string> > _denLepsIsoIdx;
  ...
  vector<pair<unsigned int, string> > _numElsIsoIdx;
  vector<pair<unsigned int, string> > _numLepsIsoIdx;

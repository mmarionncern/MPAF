...
void SUSY3L_trig::initialize(){
    ...
    */
    ...
    _vc->registerVar("HLT_DoubleMuHT"                  );     //(simulated) HLT decition HLT_DoubleMu8_Mass8_PFHT300_v1 trigger
    _vc->registerVar("HLT_DoubleElHT"                  );     //(simulated) HLT decition HLT_DoubleEle8_CaloIdM_TrackIdM_Mass8_PFHT300_v1 trigger
...
void SUSY3L_trig::defineOutput(){
    ...
    */
    ...
    _hm->addVariable("DoubleMuHT"                   ,  40,     0.0,  1000.0,    "HT of di-muon events [GeV]"                );
    _hm->addVariable("DoubleMuHT_triggered"         ,  40,     0.0,  1000.0,    "HT of triggered di-muon events [GeV]"      );
    _hm->addVariable("DoubleMuHT_lepPt"             ,  50,     0.0,   50.0,    "pt of 2nd muon [GeV]"                      );
    _hm->addVariable("DoubleMuHT_lepPt_triggered"   ,  50,     0.0,   50.0,    "pt of 2nd muon, triggered events [GeV]"    );
    _hm->addVariable("DoubleElHT"                   ,  40,     0.0,  1000.0,    "HT of di-electron events [GeV]"                );
    _hm->addVariable("DoubleElHT_triggered"         ,  40,     0.0,  1000.0,    "HT of triggered di-electron events [GeV]"      );
    _hm->addVariable("DoubleElHT_lepPt"             ,  100,     0.0,   100.0,    "pt of 2nd muon [GeV]"                      );
    _hm->addVariable("DoubleElHT_lepPt_triggered"   ,  100,     0.0,   100.0,    "pt of 2nd muon, triggered events [GeV]"    );
...
//____________________________________________________________________________
bool SUSY3L_trig::electronSelection(int elIdx){
    /*
...
//____________________________________________________________________________
bool SUSY3L_trig::muonSelection(int muIdx){
    /*
        selection of muons
        parameters: muIdx
...
//____________________________________________________________________________
bool SUSY3L_trig::vetoElectronSelection(int elIdx){
    /*
...
//____________________________________________________________________________
bool SUSY3L_trig::vetoMuonSelection(int muIdx){
    /*
...
//____________________________________________________________________________
bool SUSY3L_trig::goodJetSelection(int jetIdx){
    /*
        selection of jets
        parameters: jetIdx
...
//____________________________________________________________________________
bool SUSY3L_trig::bJetSelection(int jetIdx){
    /*
...
//____________________________________________________________________________
void SUSY3L_trig::setMultiIsoWP(){
    /*
...
//____________________________________________________________________________
bool SUSY3L_trig::baseSelection(){
    /*
    ...
    */
    ...
    if(!makeCut<int>( _nMus, _valCutLepMultiplicityBR, _cTypeLepMultiplicityBR, "lepton multiplicity", _upValCutLepMultiplicityBR ) ) return false;
...
//    }
    ...
    //sortSelectedLeps();
    //fill("DoubleElHT_lepPt", _leps[0]->pt(), _weight);
    ...
    fill("DoubleMuHT", _HT, _weight);
    
    bool trigFired = false; 
    if(_vc->get("HLT_DoubleMuHT")==1){trigFired = true;}
    if(!makeCut( trigFired , "HLT_DoubleMuHT fired", "=")) return false;
        
    fill("DoubleMuHT_triggered", _HT, _weight);
    //fill("DoubleElHT_lepPt_triggered", _leps[0]->pt(), _weight);
...
//____________________________________________________________________________
bool SUSY3L_trig::checkMultiIso(){
    /*
...
//____________________________________________________________________________
bool SUSY3L_trig::hardLegSelection(){
    /*
...
//____________________________________________________________________________
float SUSY3L_trig::lowestOssfMll(){
    /*
...
//____________________________________________________________________________
bool SUSY3L_trig::ZEventSelectionLoop(){
    /*
...
//____________________________________________________________________________
void SUSY3L_trig::fillEventPlots(std::string kr){
    /*
...
//____________________________________________________________________________
bool SUSY3L_trig::electronMvaCut(int idx, int wp){
    /*
...
//____________________________________________________________________________
bool SUSY3L_trig::multiIsolation(int idx, float miniRelIso_cut, float ptRatio_cut, float ptRel_cut){
    /*
...
//____________________________________________________________________________
void SUSY3L_trig::sortSelectedLeps(){
    /*

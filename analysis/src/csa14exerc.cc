...
csa14exerc::csa14exerc(std::string cfg){
  /* 
     constructs the csa14exerc class 
...
//____________________________________________________________________________
csa14exerc::~csa14exerc(){
  /* 
     destructs the csa14exerc class 
     parameters: none
     return: none
  */
...
//____________________________________________________________________________
void csa14exerc::initialize(){
  /*
    initializes the csa14exerc class
    parameters: none
    return: none
  */
...
//____________________________________________________________________________
void csa14exerc::modifySkimming(){
...
//____________________________________________________________________________
bool csa14exerc::bJetSelection(int jetIdx){
  /*
...
//____________________________________________________________________________
void csa14exerc::collectKinematicObjects(){
  /*
...
//____________________________________________________________________________
bool csa14exerc::goodJetSelection(int jetIdx){
  /*
...
//____________________________________________________________________________
bool csa14exerc::electronSelection(int elIdx){
  /*
...
//____________________________________________________________________________
bool csa14exerc::muonSelection(int muIdx){
  /*
...
//____________________________________________________________________________
bool csa14exerc::vetoElectronSelection(int elIdx){
  /*
...
//____________________________________________________________________________
bool csa14exerc::vetoMuonSelection(int muIdx){
  /*
...
//____________________________________________________________________________
void csa14exerc::setBaselineRegion(){
  /*
...
//____________________________________________________________________________
void csa14exerc::setCut(std::string var, float valCut, std::string cType, float upValCut) {
  /*
...
//____________________________________________________________________________
void csa14exerc::setSignalRegion() {
  /*
...
//____________________________________________________________________________
bool csa14exerc::ssEventSelection(){
  /*
...
//____________________________________________________________________________
bool csa14exerc::vetoEventSelection(std::string electron_label, std::string muon_label, std::string kr){
  /*
...
//____________________________________________________________________________
void csa14exerc::fillEventPlots(std::string kr){
  /*
...
//____________________________________________________________________________
void csa14exerc::fillLeptonPlots(std::string kr){
  /*
...
//____________________________________________________________________________
void csa14exerc::fillJetPlots(std::string kr){
  /*

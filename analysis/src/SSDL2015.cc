...
SSDL2015::initialize(){
  ...
  _dbm->loadDb("T1tttXsect", "SignalXsect.db");
...
SSDL2015::checkMassBenchmark() {
  ...
  //cout<<_dbm->getDBValue("T1tttXsect",M1)*2110/_nProcEvtScan<<"  "<<_weight<<endl;
  _weight *= _dbm->getDBValue("T1tttXsect",M1)*2110/_nProcEvtScan;
  return true;
}

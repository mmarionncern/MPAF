...
void ttVPlotsTRAININGPROC(){
  ...
  //observables **********************
  md.setObservables("NeuralNetTRAINING");//"NN2DWZtZq","NN2DWZtZW","NN2DWZttH");
  ...
  md.anConf.addSample( "PROC","ttZ", kRed+1 );
  ...
  //md.drawDetailSyst(1);
  md.drawDetailSyst(0);
  md.savePlot("TTVControl","TRAININGControlPROC");

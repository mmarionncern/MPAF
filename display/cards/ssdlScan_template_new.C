...
void ssdlScan_BENCH() {
  ...
  md.addDataCardSample("data:flip:DYJetsToLL_M10to50"                             , "flip"    );
  md.addDataCardSample("data:flip:DYJetsToLL_M50"                                 , "flip"    );
  md.addDataCardSample("fake:TTWToLNu"                                            , "flip", -1);
  md.addDataCardSample("fake:TTZToLLNuNu"                                         , "flip", -1);
  md.addDataCardSample("fake:TTLLJets_m1to10"                                     , "flip", -1);
  md.addDataCardSample("fake:TTHnobb"                                             , "flip", -1);
  md.addDataCardSample("fake:WZTo3LNu"                                            , "flip", -1);
  md.addDataCardSample("fake:WpWpJJ"                                              , "flip", -1);
  md.addDataCardSample("fake:TTGJets"                                             , "flip", -1);
  md.addDataCardSample("fake:TGJets"                                              , "flip", -1);
  md.addDataCardSample("fake:WGToLNuG"                                            , "flip", -1);
  md.addDataCardSample("fake:ZGTo2LG"                                             , "flip", -1);
  md.addDataCardSample("fake:WWDouble"                                            , "flip", -1);
  md.addDataCardSample("fake:ZZTo4L"                                              , "flip", -1);
  md.addDataCardSample("fake:tZq_ll"                                              , "flip", -1);
  md.addDataCardSample("fake:GGHZZ4L"                                             , "flip", -1);
  md.addDataCardSample("fake:VHToNonbb"                                           , "flip", -1);
  md.addDataCardSample("fake:WWZ"                                                 , "flip", -1);
  md.addDataCardSample("fake:ZZZ"                                                 , "flip", -1);
  md.addDataCardSample("fake:WZZ"                                                 , "flip", -1);
  md.addDataCardSample("fake:TTTT"                                                , "flip", -1);

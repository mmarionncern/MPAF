...
*/
    ...
    md.anConf.addSample( "T5qqqqWZ_mGo1200_mCh1000_mChi800_lep"       ,  "T5q4WZ (1200) x10 sig"   , kRed-6, 10  );
    md.anConf.addSample( "T5qqqqWZ_mGo1500_mCh800_mChi100_lep"        ,  "T5q4WZ (1500) x10 sig"   , kRed+3, 10  );
    ...
    //data
    if(data){
    md.anConf.addSample( "DoubleEG_Run2016B_PromptReco_v2_runs_271036_274421"      , "data"          , kBlack    );
    md.anConf.addSample( "DoubleMuon_Run2016B_PromptReco_v2_runs_271036_274421"    , "data"          , kBlack    );
    md.anConf.addSample( "MuonEG_Run2016B_PromptReco_v2_runs_271036_274421"        , "data"          , kBlack    );
    }
   ...
   string categs[32]={
    ...
    //md.getStatistics("global", true, false);
    }

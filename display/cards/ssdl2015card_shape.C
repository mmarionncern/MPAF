...
void dataCardProd_shape_SIGTAG() {
  md.refresh();
  ...
  md.addDataCardSigSample("SIGNAME","SIGTAG");
  ...
  //shape uncertainties
  md.addNuisanceParameter("JES","ttW:ttZH:WZ:WW:XG:rares:SIGTAG","shape","");
  md.addNuisanceParameter("BTAG","ttW:ttZH:WZ:WW:XG:rares:SIGTAG","shape","");
  md.addNuisanceParameter("tHTE","ttW:ttZH:WZ:WW:XG:rares:SIGTAG","shape","");
  ...
  vector<string> dss({"ttW","ttHZ","WZ","WW","XG","rares","SIGTAG"});
  for(int isr=0;isr<cats.size();isr++) {
  ...
  vector<string> categs({"global_HHSR1","global_HHSR2","global_HHSR3","global_HHSR4",
  ...
  md.makeMultiDataCard("SIGTAG", categs, "selected", "ssdl2015_SIGTAG");

...
void susy3l_76X(){
    ...
    string sig="T1tttt_mGo1500_mChi100";
    bool allSR = true;
    ...
    md.addDataCardSample( "TTZToLLNuNu_LO", "ttzh"); 
    ...
    md.addDataCardSample( "TTJets", "fakes");
    md.addDataCardSample( "TToLeptons_sch", "fakes");
    md.addDataCardSample( "TToLeptons_tch_powheg", "fakes");
    md.addDataCardSample( "TBarToLeptons_tch_powheg", "fakes");
    md.addDataCardSample( "TBar_tWch", "fakes");
    md.addDataCardSample( "T_tWch", "fakes");
    md.addDataCardSample( "WJetsToLNu", "fakes");
    md.addDataCardSample( "WWTo2L2Nu", "fakes");
    md.addDataCardSample( "ZZTo2L2Nu", "fakes");

    //md.addDataCardSample( "data:Fake:DoubleEG_Run2015C_25ns_16Dec2015", "fakes"); 
    //md.addDataCardSample( "data:Fake:DoubleEG_Run2015D_16Dec2015", "fakes"); 
    //md.addDataCardSample( "data:Fake:DoubleMuon_Run2015C_25ns_16Dec2015", "fakes"); 
    //md.addDataCardSample( "data:Fake:DoubleMuon_Run2015D_16Dec2015", "fakes"); 
    //md.addDataCardSample( "data:Fake:MuonEG_Run2015C_25ns_16Dec2015", "fakes"); 
    //md.addDataCardSample( "data:Fake:MuonEG_Run2015D_16Dec2015", "fakes");
    ...
    md.addDataCardSample( "Fake:TTZToLLNuNu_LO", "fakes", -1 );
    ...
    */
    ...
    md.addDataCardSample( "TTZToLLNuNu_LO", "pseudodata"); 
    ...
    md.addDataCardSample( "TTJets", "pseudodata");
    md.addDataCardSample( "TToLeptons_sch", "pseudodata");
    md.addDataCardSample( "TToLeptons_tch_powheg", "pseudodata");
    md.addDataCardSample( "TBarToLeptons_tch_powheg", "pseudodata");
    ...
    md.addDataCardSample( "WWTo2L2Nu", "pseudodata");
    md.addDataCardSample( "ZZTo2L2Nu", "pseudodata");

   
    /*
    md.addDataCardSample( "data:Fake:DoubleEG_Run2015C_25ns_16Dec2015", "pseudodata"); 
    md.addDataCardSample( "data:Fake:DoubleEG_Run2015D_16Dec2015", "pseudodata"); 
    md.addDataCardSample( "data:Fake:DoubleMuon_Run2015C_25ns_16Dec2015", "pseudodata"); 
    md.addDataCardSample( "data:Fake:DoubleMuon_Run2015D_16Dec2015", "pseudodata"); 
    md.addDataCardSample( "data:Fake:MuonEG_Run2015C_25ns_16Dec2015", "pseudodata"); 
    md.addDataCardSample( "data:Fake:MuonEG_Run2015D_16Dec2015","pseudodata");
    ...
    */
    ...
    //md.addDataCardSample( "DoubleEG_Run2015C_25ns_16Dec2015  ", "data"); 
    //md.addDataCardSample( "DoubleEG_Run2015D_16Dec2015  ", "data"); 
    //md.addDataCardSample( "DoubleMuon_Run2015C_25ns_16Dec2015  ", "data"); 
    //md.addDataCardSample( "DoubleMuon_Run2015D_16Dec2015  ", "data"); 
    //md.addDataCardSample( "MuonEG_Run2015C_25ns_16Dec2015  ", "data"); 
    //md.addDataCardSample( "MuonEG_Run2015D_16Dec2015  ","data");

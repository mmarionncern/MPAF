...
void ssdlScan_test() {
  ...
  string dir="SSDL2015";
  string fileName="ssdlScan_test"; // not needed for statistics but provides the normalization
  string fileList="ssdlScan_test"; // put command line that gives all files as in a "ls" command
  ...
  md.addDataCardSigSample("T1tttt-1125-775-","T1tttt_1125_775");
  ...
  //shape uncertainties
  md.addNuisanceParameter("JES","ttW:ttZH:WZ:WW:XG:rares:T1tttt_1125_775","shape","");
  md.addNuisanceParameter("BTAG","ttW:ttZH:WZ:WW:XG:rares:T1tttt_1125_775","shape","");
  md.addNuisanceParameter("tHTE","ttW:ttZH:WZ:WW:XG:rares:T1tttt_1125_775","shape","");
  ...
  //vector<string> dss; 
  string dss[7]={"ttW","ttHZ","WZ","WW","XG","rares","T1tttt_1125_775"};
  ...
  //Flat uncertanties =================================
  //lumi
  md.addNuisanceParameter("lumi","ttW:ttHZ:WW:XG:rares:T1tttt_1125_775","lnN","1.12:1.12:1.12:1.12:1.12:1.12:1.12");
  //experimental uncertainties
  md.addNuisanceParameter("lEff","ttW:ttHZ:WW:XG:rares:T1tttt_1125_775","lnN","1.04:1.04:1.04:1.04:1.04:1.04");
  md.addNuisanceParameter("tEff","ttW:ttHZ:WW:XG:rares:T1tttt_1125_775","lnN","1.02:1.02:1.02:1.02:1.02:1.02");
  //Data-driven methods
  ...
  md.makeMultiDataCard("T1tttt_1125_775", vcategs, "selected", "ssdl2015_T1tttt_1125_775");

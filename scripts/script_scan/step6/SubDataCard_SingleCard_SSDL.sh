...
for i in `ls $MPAF/workdir/stats/SSDL2015/ssdl_scanSig_$SIG_*.dat`; do
        ...
        cp $MPAF/display/cards/ssdl2016_scan.C $MPAF/display/cards/tmpFiles/ssdl2016_scanSig_${sig}.C

        sed -i 's|SIGNAME|'$sig'|' $MPAF/display/cards/tmpFiles/ssdl2016_scanSig_${sig}.C
        sed -i 's|SIGTAG|'$sig'|' $MPAF/display/cards/tmpFiles/ssdl2016_scanSig_${sig}.C
...
#done
	...
	qsub -q short.q -N card$sig -o $MPAF/workdir/logs/card_${sig}.out -e $MPAF/workdir/logs/card_${sig}.err $MPAF/scripts/script_scan/step6/subSingleCard.sh $MPAF ssdl2016_scanSig_${sig}.C
